...
## Collaboration at Chonnam National University

The platform is built to be shared. Chip fabrication, bioprinting and modelling each
sit with people who do them better than we do.

- **Prof. Dong-Weon Lee** (Mechanical Engineering) — bioMEMS and microfluidics, chip co-development
- **Prof. Hee-Gyeong Yi** (Convergence Biosystems Engineering) — 3D bioprinting integration
- **Graduate School of Data Science** — model development on the data the platform produces
